...
export default class FinishedJobsList extends Component {
  ...
  clickEventListener = (item) => {
    ...
    this.props.navigation.navigate('finishjobsdetail',item)
  }
  onRefresh() {
  ...
  getJobsList = () => {
    ...
    fetch(url,{
      method:"POST",
      body:'id='+this.state.usID +"&job_status=" + "finish",
      headers: new Headers({
